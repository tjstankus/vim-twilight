...
let s:red = '#d08356'
let s:cyan = '#74dad9'
let s:darkgrey = '#1e1e1e'
let s:darkergrey = '#131313'
let s:black = '#000000'
let s:grey = '#303030'
...
exe 'hi Normal         guifg='.s:white             .' guibg='.s:darkergrey
exe 'hi Underlined     guifg='.s:white             .' guibg='.s:darkergrey        .' gui=underline'
exe 'hi NonText        guifg='.s:lightgrey         .' guibg='.s:darkergrey
exe 'hi SpecialKey     guifg='.s:grey              .' guibg='.s:darkergrey
...
exe 'hi Comment        guifg='.s:mid_grey_blue     .' guibg='.s:darkergrey        .' gui=italic'
exe 'hi TODO           guifg='.s:grey_blue         .' guibg='.s:darkergrey        .' gui=italic,bold'

exe 'hi Title          guifg='.s:red               .' guibg='.s:darkergrey        .' gui=underline'

exe 'hi Constant       guifg='.s:red               .' guibg='.s:darkergrey        .' gui=none'
exe 'hi String         guifg='.s:green             .' guibg='.s:darkergrey        .' gui=none'
exe 'hi Special        guifg='.s:lightgreen        .' guibg='.s:darkergrey        .' gui=none'

exe 'hi Identifier     guifg='.s:grey_blue         .' guibg='.s:darkergrey        .' gui=none'
exe 'hi Statement      guifg='.s:beige             .' guibg='.s:darkergrey        .' gui=none'
exe 'hi Conditional    guifg='.s:beige             .' guibg='.s:darkergrey        .' gui=none'
exe 'hi Repeat         guifg='.s:beige             .' guibg='.s:darkergrey        .' gui=none'
exe 'hi Structure      guifg='.s:beige             .' guibg='.s:darkergrey        .' gui=none'
exe 'hi Function       guifg='.s:violet            .' guibg='.s:darkergrey        .' gui=none'

exe 'hi PreProc        guifg='.s:grey_blue         .' guibg='.s:darkergrey        .' gui=none'
exe 'hi Operator       guifg='.s:light_orange      .' guibg='.s:darkergrey        .' gui=none'
exe 'hi Type           guifg='.s:yellow            .' guibg='.s:darkergrey        .' gui=italic'
